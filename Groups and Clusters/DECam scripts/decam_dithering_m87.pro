survey_tile = [ {tile:1, coo:['12:30:50.0','12:18:40.0']} ]

survey = { ob1:{ target:'M87', filter:'u', tile:[1], exptime:[90]}, $
	ob2:{ target:'M87', filter:'g', tile:[1], exptime:[90]}, $
	ob3:{ target:'M87', filter:'r', tile:[1], exptime:[90]}, $
	ob4:{ target:'M87', filter:'i', tile:[1], exptime:[90]}, $
	ob5:{ target:'M87', filter:'z', tile:[1], exptime:[90]} } 
...
n_dither=3;n_elements(offset_ra)
...
;			if k EQ 0 AND j GT 0 then continue
			...
			printf, lun, ' {'
			printf, lun, '  "count": 1, '
			printf, lun, '  "seqtot": '+strn(n_dither)+', '
