pro decam_dithering_ngc3115

survey_tile = [ {tile:1, coo:['10:05:12.7','-07:42:28.9']} ]

survey = { ob1:{ target:'NGC3115', filter:'u', tile:[1,1,2,3,4,5,6,7,10,13], exptime:[30,600,600,600,600,600,600,600,600,600]}, $
	ob2:{ target:'NGC3115', filter:'g', tile:[1,1,2,3,4,5,6,7,10,13], exptime:[30,300,300,300,300,300,300,300,300,300]}, $
	ob3:{ target:'NGC3115', filter:'i', tile:[1,1,2,3,4,5,6,7,10,13], exptime:[30,300,300,300,300,300,300,300,300,300]} } 
